...
function Dashboard() {
  ...
  const clinics = [
    {
      id: 'clinic1',
      name: 'ГАУЗ АО "Городская поликлиника №1"',
      positions: ['детский кардиолог ', 'детский уролог-андролог ','  Врач-хирург',' Врач - детский эндокринолог','  Врач - детский онколог'],
      statuses: ['Достаток', 'Достаток','Дефицит', 'Достаток','Дефицит', 'Достаток'],
    },
    {
      id: 'clinic2',
      name: 'Clinic 2',
